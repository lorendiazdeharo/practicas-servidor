...
public class ClienteController {
	...
	public ModelAndView save(@PathVariable("add") String add,@ModelAttribute("clienteDTO") ClienteDTO clienteDTO, Model modelo) {
		
		log.info("ClienteController - save: Salvamos los datos del cliente:" + clienteDTO.toString());
		log.info("ClienteController - save: El salvado de datos viene de la operacion: " + (Integer.valueOf(add) == 0 ? "update" : "add"));
