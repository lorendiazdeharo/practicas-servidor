...
public class ClienteRepositoryImpl implements ClienteRepository {
	...
	static {
		...
		Cuenta cl3 = new Cuenta();
		cl3.setId(Long.valueOf(c1.getListaCuentas().size() + 1));
		cl3.setBanco("1500");
		cl3.setSucursal("8534");
		cl3.setDc("02");
		cl3.setNumeroCuenta("5933846578");
		cl3.setSaldoActual(45.99);
		cl3.setCliente(c2);		
		c2.getListaCuentas().add(cl3);		
